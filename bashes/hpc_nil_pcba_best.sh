...
--backbone_type gin_virtual --bottle_type upsample --L 123 --V 30 \
--drop_ratio 0 --scheduler False --dis_loss noisy_ce_sample \
...
--run_name nil_ginv_pcba_dp0_noisycesmpl_earlystp
...
--drop_ratio 0 --scheduler False --dis_loss ce_sample \
--dis_lr 0.0007565782660579647 --dis_sem_tau 1 --dis_smp_tau 2 --epochs_dis 4 --teach_last_best best --dis_loss ce_argmax \
--epochs_ft 1000 --es_epochs 4 --ft_lr 0.000106491 --ft_tau 0.834511539 \
--run_name nil_gcn_pcba_dp0_noisycesmpl_earlystp_besthyper